#include <container/simple/array.hpp>
...
using index_t = Array<u8, 0>::Index;
static const index_t SIZE = 5;

int main(int, char**) {
  static_assert(test_interface<Aversive::Container::Array, Array<u8, SIZE>>(), "ERROR : Class don't follow the Array interface");
  static_assert(test_interface<Aversive::Container::Array, Array<bool, SIZE>>(), "ERROR : Class don't follow the Array interface");

  static_assert(test_interface<Aversive::Container::Container, Array<u8, SIZE>>(), "ERROR : Class don't follow the Container interface");
  static_assert(test_interface<Aversive::Container::Container, Array<bool, SIZE>>(), "ERROR : Class don't follow the Container interface");

  static_assert(test_interface<Aversive::Container::Limited, Array<u8, SIZE>>(), "ERROR : Class don't follow the Limited interface");
  static_assert(test_interface<Aversive::Container::Limited, Array<bool, SIZE>>(), "ERROR : Class don't follow the Limited interface");

  static_assert(test_interface<Aversive::Container::Iterable, Array<u8, SIZE>>(), "ERROR : Class don't follow the Iterable interface");
  //static_assert(test_interface<Aversive::Container::Iterable, Array<bool, SIZE>>(), "ERROR : Class don't follow the Iterable interface");
